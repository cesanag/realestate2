...
function ButtonsFilters({onFilterClick, onMapClick}) {
   /* const [toggleButton, setToggleButton] = useState(true);
    //const toggleFilterButton = `Filters-Container ${toggleFilters ? "is-visible" : "is-hidden"}`
    const toggleButtonClasses = `buttonsfilters-button ${toggleButton ? "button-is-clicked" : "button-not-clicked"}`
        ...
        <div className="buttonsfilters-container">
            <div className="buttonfilters-content">
                ...
                <div className="buttonsfilters-buttoncontainer">
                    <button onClick={onFilterClick} className="buttonsfilters-button button-is-clicked">
                        <img className="buttonsfilters-img" alt="icon-filter"src={iconFilters} />
                            {Copy.filter}
                    </button>
                    ...
                    <button className="buttonsfilters-button button-is-clicked"
                        onClick={onMapClick}>
                            <img className="buttonsfilters-img" alt="icon-map"src={iconMap} />
                    {Copy.map}
                    </button>
                </div>
            </div>
