...
import {CopyButtonFilters, CopyMain, CopyFilters} from './Copy/Copy'
        ...
        <div className="buttonsfilters-container">
            <div className="buttonfilters-content">
                    <div className="search-container">
                        <input className="search-input" type="search" placeholder={CopyFilters.search + " " + CopyMain.company + "..."} />
                ...
                <div className="buttonsfilters-buttoncontainer">
                    <button className="buttonsfilters-button">{CopyButtonFilters.filter}</button>
                    <button className="buttonsfilters-button">{CopyButtonFilters.order}</button>
                    <button className="buttonsfilters-button">{CopyButtonFilters.map}</button>
                </div>
            </div>
            <div className="property-found"> 148 {CopyButtonFilters.found} {CopyButtonFilters.city}</div>
        </div>   
    );
  }
